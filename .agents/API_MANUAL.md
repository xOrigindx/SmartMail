...
## Vanilla UI & XML Pitfalls (1.12.1)

All UI reference types and API signatures can be found in `docs/References/type-definitions/UI_Vanilla/`. *Always check these files when implementing native UI components.*

### XML Script `self` vs `this`
- **CRITICAL:** In 1.12.1 XML `<Scripts>`, you CANNOT use `self`. You must use `this`.
- Example: `getglobal(this:GetName().."Title"):SetText("My Window")`
- Example: `this:RegisterForDrag("LeftButton")`

### Draggable Frames
To make a frame draggable, it must have `movable="true"` and `enableMouse="true"` in the `<Frame>` tag, and the following in its `<Scripts>`:
```xml
<OnLoad>
...
### Scrolling EditBoxes
When placing an `<EditBox>` inside a `<ScrollFrame>` (inheriting `UIPanelScrollFrameTemplate`), you must wire up the Blizzard native scrolling events to recalculate the scrollbar height:
```xml
<OnTextChanged>
  ScrollingEdit_OnTextChanged(MyScrollFrame)
</OnTextChanged>
<OnCursorChanged>
  ScrollingEdit_OnCursorChanged(arg1, arg2, arg3, arg4)
</OnCursorChanged>
<OnUpdate>
  ScrollingEdit_OnUpdate(MyScrollFrame)
</OnUpdate>
```

### DropDown Menus (UIDropDownMenu)
See `UIDropDownMenu.d.lua` for exact signatures.
- **Initialize:** `UIDropDownMenu_Initialize(frame, initFunction, displayMode, level)`
- **Add Item:** `UIDropDownMenu_AddButton(info, level)` (Where `info` is a table containing `.text`, `.func`, `.value`, etc.)
- **Set Selected Value/Text:** `UIDropDownMenu_SetSelectedValue(frame, value)` or `UIDropDownMenu_SetText(text, frame)`
- **Get Selected Value:** `UIDropDownMenu_GetSelectedValue(frame)`


## Vanilla UI Type Definitions Index

The following is an auto-generated index of all Vanilla UI constants and functions pulled from `docs/References/type-definitions/UI_Vanilla/`.
...
**Functions:**
- `ActionButtonDown(id)`
- `ActionButtonUp(id, onSelf)`
- `ActionBar_PageUp()`
- `ActionBar_PageDown()`
- `ActionButton_OnLoad()`
- `ActionButton_UpdateHotkeys(actionButtonType)`
- `ActionButton_Update()`
...
- `AttackButton_OnEvent(event)`
- `AttackButton_OnUpdate(elapsed)`
...
- `AuctionsRadioButton_OnClick(index)`
- `UpdateDeposit()`
- `AuctionSellItemButton_OnEvent()`
- `AuctionsFrameAuctions_ValidateAuction()`
- `AuctionFrame_GetTimeLeftText(id)`
- `AuctionFrame_GetTimeLeftTooltipText(id)`
- `AuctionFrameItem_OnEnter(type, index)`
- `SortButton_UpdateArrow(button, type, sort)`
...
- `BattlefieldFrame_UpdateStatus(tooltipOnly)`
- `BattlefieldFrame_Update()`
- `BattlefieldButton_OnClick(id)`
- `BattlefieldFrameJoinButton_OnClick(joinAsGroup)`
- `MiniMapBattlefieldDropDown_OnLoad()`
- `MiniMapBattlefieldDropDown_Initialize()`
- `BattlegroundShineFadeIn()`
- `BattlegroundShineFadeOut()`
- `IsAlreadyInQueue(mapName)`

### BonusActionBarFrame.d.lua
...
- `BonusActionBar_OnUpdate(elapsed)`
- `ShowBonusActionBar()`
- `HideBonusActionBar()`
- `BonusActionButton_OnEvent()`
- `BonusActionButtonUp(id)`
- `BonusActionButtonDown(id)`
- `BonusActionBar_SetButtonTransitionState(state)`
- `ShapeshiftBar_OnLoad()`
- `ShapeshiftBar_OnEvent()`
- `ShapeshiftBar_Update()`
- `ShapeshiftBar_UpdateState()`
- `ShapeshiftBar_ChangeForm(id)`
...
- `BuffFrame_Enchant_OnUpdate(elapsed)`
- `BuffFrame_EnchantButton_OnUpdate()`
- `BuffFrame_EnchantButton_OnEnter()`
- `BuffFrame_UpdateDuration(buffButton, timeLeft)`
- `RefreshBuffs(button, showBuffs, unit)`

### CastingBarFrame.d.lua
...
- `ChatFrame_OnUpdate(elapsedSec)`
- `ChatFrame_OnHyperlinkShow(link, text, button)`
- `ChatFrame_OnMouseWheel(value)`
- `ChatFrame_OpenChat(text, chatFrame)`
- `ChatFrame_ScrollToBottom()`
- `ChatFrame_ScrollUp()`
- `ChatFrame_ScrollDown()`
- `MessageFrameScrollButton_OnLoad()`
- `MessageFrameScrollButton_OnUpdate(elapsed)`
- `ChatFrame_OpenMenu()`
- `ChatFrame_SendTell(name, chatFrame)`
- `ChatFrame_ReplyTell(chatFrame)`
- `ChatFrame_ReplyTell2(chatFrame)`
- `ChatFrame_DisplayStartupText(frame)`
- `ChatFrame_DisplayHelpText(frame)`
- `ChatFrame_DisplayMacroHelpText(frame)`
- `ChatFrame_DisplayChatHelp(frame)`
- `ChatFrame_DisplayGuildHelp(frame)`
- `ChatFrame_DisplayGameTime(frame)`
- `ChatFrame_TimeBreakDown(time)`
- `ChatFrame_DisplayTimePlayed(totalTime, levelTime)`
- `ChatFrame_ChatPageUp()`
- `ChatFrame_ChatPageDown()`
- `ChatEdit_OnLoad()`
- `ChatEdit_OnUpdate(elapsedSec)`
- `ChatEdit_OnShow()`
- `ChatEdit_GetLastTellTarget(editBox)`
- `ChatEdit_GetLastToldTarget(editBox)`
- `ChatEdit_SetLastToldTarget(editBox, name)`
- `ChatEdit_SetLastTellTarget(editBox, target)`
- `ChatEdit_GetNextTellTarget(editBox, target)`
- `ChatEdit_UpdateHeader(editBox)`
- `ChatEdit_AddHistory(editBox)`
- `ChatEdit_SendText(editBox, addHistory)`
...
- `ChatMenu_SetChatType(chatFrame, type)`
- `ChatMenu_Say()`
- `ChatMenu_Party()`
- `ChatMenu_Guild()`
- `ChatMenu_Yell()`
...
- `ChatMenu_OnShow()`
- `EmoteMenu_Click()`
- `TextEmoteSort(token1, token2)`
- `OnMenuLoad(list, func)`
- `EmoteMenu_OnLoad()`
- `LanguageMenu_OnLoad()`
...
- `LanguageMenu_Click()`
- `ChatFrame_ActivateCombatMessages(chatFrame)`

### CinematicFrame.d.lua

**Functions:**
- `CinematicFrame_OnLoad()`
- `CinematicFrame_OnEvent()`

### ClassTrainerFrame.d.lua
...
- `ClassTrainer_SetSelection(id)`
- `ClassTrainerSkillButton_OnClick(button)`
- `ClassTrainerTrainButton_OnClick()`
- `ClassTrainer_SetSubTextColor(button, r, g, b)`
- `ClassTrainerSkillButton_OnEnter()`
- `ClassTrainerSkillButton_OnLeave()`
- `ClassTrainerSortButton_OnClick(type)`
- `ClassTrainerSortButton_OnShow(button, type)`
...
### CoinPickupFrame.d.lua

**Functions:**
- `OpenCoinPickupFrame(multiplier, maxMoney, parent)`
- `UpdateCoinPickupFrame(maxMoney)`
...
**Functions:**
- `CombatFeedback_Initialize(feedbackText, fontHeight)`
- `CombatFeedback_OnCombatEvent(event, flags, amount, type)`
...
**Functions:**
- `ToggleCombatLog()`
- `CombatLogUpButton_OnClick(button)`
- `CombatLogDownButton_OnClick(button)`
...
- `ComboPointShineFadeIn(frame)`
- `ComboPointShineFadeOut(frameName)`

### ContainerFrame.d.lua
...
- `ContainerFrame_UpdateCooldown(container, button)`
...
- `ContainerFrameItemButton_OnUpdate(elapsed)`
- `OpenAllBags(forceOpen)`
- `CloseAllBags()`
- `KeyRingItemButton_OnClick(button)`
- `PutKeyInKeyRing()`
- `ToggleKeyRing()`
- `GetKeyRingSize()`
...
- `CraftFrame_OnEvent()`
- `CraftFrame_Update()`
- `CraftFrame_SetSelection(id)`
- `CraftButton_OnClick(button)`
...
- `DurabilityFrame_OnUpdate(elapsed)`

### FadingFrame.d.lua

**Functions:**
- `FadingFrame_SetFadeInTime(this, time)`
- `FadingFrame_SetHoldTime(this, time)`
- `FadingFrame_SetFadeOutTime(this, time)`
- `FadingFrame_OnLoad()`
- `FadingFrame_Show()`
- `FadingFrame_OnUpdate()`

### FloatingChatFrame.d.lua
...
- `FloatingChatFrame_Update(id, onUpdateEvent)`
...
- `FCFDropDown_LoadChatTypes(menuChatTypeGroups)`
- `FCF_LoadChatSubTypes(chatGroup)`
- `FCFMessageTypeDropDown_OnClick()`
- `FCF_Resize(anchorPoint)`
- `FCF_StopResize()`
...
- `FCF_SetWindowColor(frame, r, g, b, doNotSave)`
...
- `FCF_CancelFontColorSettings(previousValues)`
- `FCF_CancelWindowColorSettings(previousValues)`
- `FCF_StripChatMsg(string)`
- `FCF_ToggleLock()`
- `FCF_SetLocked(chatFrame, isLocked)`
- `FCF_OnUpdate(elapsed)`
- `FCF_ChatTabFadeFinished(chatTab, chatFrame)`
- `FCF_IsValidChatFrame(chatFrame)`
- `FCF_UpdateButtonSide(chatFrame)`
- `FCF_SetButtonSide(chatFrame, buttonSide)`
- `FCF_GetButtonSide(chatFrame)`
- `FCF_DockUpdate()`
- `FCF_TabCompare(chatFrame1, chatFrame2)`
- `FCF_DockFrame(frame, index)`
- `FCF_UnDockFrame(frame)`
- `FCF_SelectDockFrame(frame)`
- `FCF_Tab_OnClick(button)`
- `FCF_SetTabPosition(chatFrame, x)`
- `FCF_GetActiveDockRegion()`
- `FCF_SaveDock()`
- `FCF_Close(frame)`
...
- `FCF_Set_SimpleChat()`
- `FCF_Set_NormalChat()`
- `FCF_Set_ChatLocked(isLocked)`
- `FCF_Get_ChatLocked()`
- `ToggleCombatLog()`
- `SetChatMouseOverDelay(noDelay)`
...
**Functions:**
- `FriendsFrame_ShowSubFrame(frameName)`
...
- `GuildFrame_GetLastOnline(guildIndex)`
...
- `GameTimeFrame_UpdateTooltip(hours, minutes)`
- `GameTime_GetTime()`
...
**Functions:**
- `HelpFrameUnstick_OnClick()`
- `HelpFrame_OnLoad()`
- `HelpFrame_OnShow()`
- `HelpFrame_OnEvent()`
- `HelpFrame_ShowFrame(key, ticketType)`
- `HelpFrame_SetupGeneralFrame(key)`
- `ToggleHelpFrame()`
- `HelpFrameOpenTicketDropDown_OnLoad()`
- `HelpFrameOpenTicketDropDown_Initialize()`
- `HelpFrameOpenTicketDropDown_OnClick()`
- `HelpFrameOpenTicketDropDown_OnShow()`
- `HelpFrameOpenTicket_OnEvent(event)`
- `HelpFrameOpenTicketSubmit_OnClick()`
- `TicketStatusFrame_OnEvent()`
- `HelpFrameButton_OnClick()`
- `HelpFrameGM_Update()`
- `HelpFrameGM_UpdateCategories(...)`
- `HelpFrameGeneralButton_OnClick()`
- `TicketStatus_OnUpdate(elapsed)`
...
- `InspectPaperDollItemSlotButton_OnClick(button)`
- `InspectPaperDollItemSlotButton_Update(button)`

### ItemButtonTemplate.d.lua

**Functions:**
- `SetItemButtonCount(button, count)`
- `SetItemButtonStock(button, numInStock)`
- `SetItemButtonTexture(button, texture)`
- `SetItemButtonTextureVertexColor(button, r, g, b)`
- `SetItemButtonDesaturated(button, desaturated, r, g, b)`
- `SetItemButtonNormalTextureVertexColor(button, r, g, b)`
- `SetItemButtonNameFrameVertexColor(button, r, g, b)`
- `SetItemButtonSlotVertexColor(button, r, g, b)`
...
- `KeyBindingFrame_GetLocalizedName(name, prefix)`
- `KeyBindingFrame_Update()`
- `KeyBindingFrame_OnKeyDown(button)`
- `KeyBindingButton_OnClick(button)`
- `KeyBindingFrame_SetBinding(key, selectedBinding, oldKey)`

### LocaleProperties.d.lua
...
**Functions:**
- `GetText(token, gender, ordinal)`
- `GetPluralIndex(ordinal)`
- `GetPluralTag(ordinal)`
- `GetGenderTag(gender)`
...
- `GroupLootFrame_OpenNewFrame(id, rollTime)`
...
- `MailFrame_Onload()`
- `MailFrame_OnEvent()`
- `MailFrameTab_OnClick(tab)`
- `InboxFrame_Update()`
- `InboxFrame_OnClick(index)`
...
- `ExhaustionTick_OnUpdate(elapsed)`
- `MainMenuBar_UpdateKeyRing()`

### MainMenuBarBagButtons.d.lua
...
### MainMenuBarMicroButtons.d.lua

**Functions:**
- `LoadMicroButtonTextures(name)`
- `MicroButtonTooltipText(text, action)`
- `UpdateMicroButtons()`
...
- `MerchantItemButton_OnClick(button, ignoreModifiers)`

### MinigameFrame.d.lua

**Functions:**
- `MinigameFrame_OnEvent(event)`
- `MinigameFrame_Update()`
...
- `Minimap_Update()`
- `Minimap_OnEvent()`
- `Minimap_OnUpdate(elapsed)`
- `Minimap_SetPing(x, y, playSound)`
- `MiniMapPing_FadeOut()`
- `Minimap_ZoomInClick()`
...
- `RefreshMoneyFrame(frameName, money, small, collapse, showSmallerCoins)`
- `SetMoneyFrameColor(frameName, r, g, b)`

### MoneyInputFrame.d.lua

**Functions:**
- `MoneyInputFrame_ResetMoney(moneyFrame)`
- `MoneyInputFrame_ClearFocus(moneyFrame)`
- `MoneyInputFrame_GetCopper(moneyFrame)`
- `MoneyInputFrame_SetTextColor(moneyFrame, r, g, b)`
- `MoneyInputFrame_SetCopper(moneyFrame, money)`
- `MoneyInputFrame_OnTextChanged(moneyFrame)`
- `MoneyInputFrame_SetMode(frame, mode)`
- `MoneyInputFrame_SetPreviousFocus(moneyFrame, focus)`
- `MoneyInputFrame_SetNextFocus(moneyFrame, focus)`
- `MoneyInputFrame_SetOnvalueChangedFunc(moneyFrame, func)`

### MultiActionBars.d.lua
...
- `MultiActionButtonUp(bar, id, onSelf)`
- `MultiActionBar_Update()`
- `MultiActionBar_ShowAllGrids()`
- `MultiActionBar_HideAllGrids()`
- `MultiActionBar_UpdateGrid(barName, show)`
- `MultiActionBar_UpdateGridVisibility()`
- `Multibar_EmptyFunc(show)`
...
- `OptionsFrameResolutionDropDown_LoadResolutions(...)`
- `OptionsFrameResolutionButton_OnClick()`
- `OptionsFrameRefreshDropDown_OnLoad()`
- `OptionsFrameRefreshDropDown_Initialize()`
- `OptionsFrame_GetRefreshRates(...)`
- `OptionsFrameRefreshDropDown_OnClick()`
- `OptionsFrameMultiSampleDropDown_OnLoad()`
- `OptionsFrameMultiSampleDropDown_Initialize()`
- `OptionsFrame_GetMultisampleFormats(...)`
- `OptionsFrameMultiSampleDropDown_OnClick()`
...
- `OptionsFrame_EnableCheckBox(checkBox, setChecked, checked, isWhite)`
- `OptionsFrame_DisableSlider(slider)`
- `OptionsFrame_EnableSlider(slider)`
- `OptionsFrame_DisableDropDown(dropDown)`
- `OptionsFrame_EnableDropDown(dropDown)`
- `PlayClickSound()`

### PaperDollFrame.d.lua
...
- `CharacterModelFrame_OnMouseUp(button)`
- `PaperDollFrame_OnEvent(event, unit)`
- `PaperDollItemSlotButton_OnLoad()`
- `PaperDollFrame_SetLevel()`
- `PaperDollFrame_SetGuild()`
- `PaperDollFrame_SetStats()`
- `PaperDollFrame_SetResistances()`
- `PaperDollFrame_SetArmor(unit, prefix)`
- `PaperDollFrame_SetDefense(unit, prefix)`
...
- `PaperDollItemSlotButton_OnClick(button, ignoreModifiers)`
- `PaperDollItemSlotButton_Update(cooldownOnly)`
- `PaperDollItemSlotButton_UpdateLock()`
- `PaperDollItemSlotButton_OnEnter()`
- `PaperDollItemSlotButton_OnUpdate(elapsed)`
- `PaperDollStatTooltip(unit, stat)`
- `PaperDollFormatStat(name, base, posBuff, negBuff, frame, textString)`
- `CharacterDamageFrame_OnEnter()`
- `CharacterRangedDamageFrame_OnEnter()`

### PartyMemberFrame.d.lua
...
- `PartyMemberFrame_UpdatePet(id)`
- `PartyMemberFrame_UpdateMemberHealth(elapsed)`
- `PartyMemberFrame_UpdateLeader()`
- `PartyMemberFrame_UpdatePvPStatus()`
- `PartyMemberFrame_OnEvent(event)`
- `PartyMemberFrame_OnUpdate(elapsed)`
- `PartyMemberFrame_OnClick(partyFrame)`
- `PartyMemberPetFrame_OnClick()`
- `PartyMemberFrame_RefreshPetBuffs(id)`
- `PartyMemberBuffTooltip_Update(isPet)`
...
- `PetActionBarFrame_OnUpdate(elapsed)`
- `PetActionBar_Update()`
...
- `PetActionButton_OnClick(button)`
...
- `PlayerFrame_OnUpdate(elapsed)`
- `PlayerFrame_OnClick(button)`
...
- `QuestFrameItems_Update(questState)`
- `QuestFrameDetailPanel_OnShow()`
- `QuestFrameDetailPanel_OnUpdate(elapsed)`
- `QuestDetailAcceptButton_OnClick()`
- `QuestDetailDeclineButton_OnClick()`
- `QuestFrame_SetMaterial(frame, material)`
- `QuestFrame_GetMaterial()`
- `QuestFrame_SetTitleTextColor(fontString, material)`
- `QuestFrame_SetTextColor(fontString, material)`
...
- `QuestLogTitleButton_OnEvent(event)`
- `QuestLog_OnLoad()`
- `QuestLog_OnEvent(event)`
- `QuestLog_OnShow()`
- `QuestLog_OnHide()`
- `QuestLog_OnUpdate(elapsed)`
- `QuestLog_Update()`
- `QuestLog_SetSelection(questID)`
- `QuestLog_UpdateQuestDetails(doNotScroll)`
- `QuestFrame_SetAsLastShown(frame, spacerFrame)`
...
- `AutoQuestWatch_Insert(questIndex, watchTimer)`
- `AutoQuestWatch_CheckDeleted()`
- `AutoQuestWatch_Update(questIndex)`
- `AutoQuestWatch_OnUpdate(elapsed)`

### QuestTimerFrame.d.lua
...
- `RaidWarningFrame_OnEvent(event, message)`

### ReputationFrame.d.lua
...
- `ReputationWatchBar_Update(newLevel)`
...
- `SkillFrame_SetStatusBar(statusBarID, skillIndex, numSkills, adjustedSkillPoints)`
- `SkillDetailFrame_SetStatusBar(skillIndex, adjustedSkillPoints)`
- `SkillFrame_UpdateSkills()`
- `SkillBar_OnClick()`

### SoundOptionsFrame.d.lua
...
- `SoundOptionsFrame_ToggleSound(isClicked)`
...
- `SpellBookFrame_Update(showing)`
- `SpellBookFrame_SetTabType(tabButton, bookType, token)`
- `SpellBookFrame_OnHide()`
- `SpellButton_OnLoad()`
- `SpellButton_OnEvent(event)`
- `SpellButton_OnEnter()`
- `SpellButton_OnUpdate(elapsed)`
- `SpellButton_OnClick(drag)`
- `SpellButton_UpdateSelection()`
- `SpellButton_UpdateButton()`
- `PrevPageButton_OnClick()`
- `NextPageButton_OnClick()`
- `SpellBookSkillLineTab_OnClick(id)`
- `SpellBook_GetSpellID(id)`
- `SpellBook_UpdatePageArrows()`
- `SpellBook_GetCurrentPage()`

### StackSplitFrame.d.lua

**Functions:**
- `OpenStackSplitFrame(maxStack, parent, anchor, anchorTo)`
- `UpdateStackSplitFrame(maxStack)`
...
- `ToggleStats()`
- `StatsFrame_OnLoad()`
- `StatsFrame_OnUpdate(elapsed)`

### SuggestFrame.d.lua

**Functions:**
- `ToggleSuggestFrame()`
- `ShowSuggestFrame(msg, type)`
- `SuggestFrameCategoryDropDown_OnLoad()`
- `SuggestFrameCategoryDropDown_Initialize()`
- `SuggestFrameCategoryDropDown_OnClick()`
...
- `TabardFrame_OnEvent(event, unit)`
- `TabardCharacterModelRotateLeftButton_OnClick()`
- `TabardCharacterModelRotateRightButton_OnClick()`
- `TabardCharacterModelFrame_OnUpdate(elapsedTime)`
- `TabardCustomization_Left(id)`
- `TabardCustomization_Right(id)`
...
- `TalentFrame_Update()`
- `TalentFrame_SetArrowTexture(tier, column, texCoords, xOffset, yOffset)`
- `TalentFrame_SetBranchTexture(tier, column, texCoords, xOffset, yOffset)`
...
- `TalentTrainer_SetSelection(id)`
- `TalentTrainerSkillButton_OnClick(button)`
- `TalentTrainerTrainButton_OnClick()`
- `TalentTrainer_SetSubTextColor(button, r, g, b)`
- `TalentTrainerSkillButton_OnEnter()`
- `TalentTrainerSkillButton_OnLeave()`
- `TalentTrainerSortButton_OnClick(type)`
- `TalentTrainerSortButton_OnShow(button, type)`
- `TalentTrainerCollapseAllButton_OnClick()`
- `TalentTrainer_HideSkillDetails()`
- `TalentTrainer_ShowSkillDetails()`
- `IsTalentTrainerTabSelected()`
...
- `TAXIROUTE_LINEFACTOR = 0`
- `TAXIROUTE_LINEFACTOR_2 = 0`

**Functions:**
- `TaxiFrame_OnLoad()`
- `TaxiFrame_OnEvent(event)`
- `TaxiNodeOnButtonEnter(button)`
- `DrawOneHopLines()`
- `DrawRouteLine(T, C, sx, sy, ex, ey, w, relPoint)`
...
- `TextStatusBar_UpdateTextString(textStatusBar)`
- `TextStatusBar_OnValueChanged()`
- `SetTextStatusBarTextPrefix(bar, prefix)`
- `SetTextStatusBarTextZeroText(bar, zeroText)`
- `ShowTextStatusBarText(bar)`
- `HideTextStatusBarText(bar)`

### TicTacToeFrame.d.lua

**Functions:**
- `TicTacToe_Update()`
- `TicTacToe_UpdateGameState(...)`
...
- `TradeFrame_OnEvent()`
- `TradeFrame_Update()`
- `TradeFrame_UpdatePlayerItem(id)`
- `TradeFrame_UpdateTargetItem(id)`
- `TradeFrame_SetAcceptState(playerState, targetState)`
...
- `TradeSkillSkillButton_OnClick(button)`
...
**Functions:**
- `UIDropDownMenu_Initialize(frame, initFunction, displayMode, level)`
- `UIDropDownMenu_OnUpdate(elapsed)`
- `UIDropDownMenu_StartCounting(frame)`
- `UIDropDownMenu_StopCounting(frame)`
...
- `UIDropDownMenu_JustifyText(justification, frame)`
- `UIDropDownMenu_SetAnchor(xOffset, yOffset, dropdown, point, relativeTo, relativePoint)`
...
- `UIErrorsFrame_OnEvent(event, message)`
...
- `UIMenu_Initialize()`
- `UIMenu_OnShow()`
- `UIMenu_AddButton(text, shortcut, func, nested)`
- `UIMenu_OnUpdate(elapsed)`
- `UIMenuButton_OnLoad()`
...
- `UIOptionsFrameClickCameraDropDown_OnClick()`
- `UIOptionsFrameClickCameraDropDown_Initialize()`
- `UIOptionsFrameTargetofTargetDropDown_OnLoad()`
- `UIOptionsFrameTargetofTargetDropDown_OnClick()`
- `UIOptionsFrameTargetofTargetDropDown_Initialize()`
- `UIOptionsFrameCameraDropDown_OnLoad()`
- `UIOptionsFrameCameraDropDown_OnClick()`
- `UIOptionsFrameCameraDropDown_Initialize()`
- `UIOptionsFrameCombatTextDropDown_OnLoad()`
- `UIOptionsFrameCombatTextDropDown_OnClick()`
- `UIOptionsFrameCombatTextDropDown_Initialize()`
- `UIOptionsFrame_SetDamageCheckBoxes(showDamage)`
- `UIOptionsFrameMultiBar_Reset()`
- `UIOptionsFrame_SetDefaults()`
- `UIOptionsFrame_UpdateDependencies()`
- `UpdateNameplates()`

### UIPanelTemplates.d.lua

**Functions:**
- `PanelTemplates_Tab_OnClick(frame)`
- `PanelTemplates_SetTab(frame, id)`
- `PanelTemplates_GetSelectedTab(frame)`
- `PanelTemplates_UpdateTabs(frame)`
- `PanelTemplates_TabResize(padding, tab, absoluteSize, maxWidth)`
...
- `ScrollFrameTemplate_OnMouseWheel(value)`
...
- `ScrollFrame_OnLoad()`
- `ScrollFrame_OnScrollRangeChanged(scrollrange)`
- `ScrollingEdit_OnTextChanged(scrollFrame)`
- `ScrollingEdit_OnCursorChanged(x, y, w, h)`
- `ScrollingEdit_OnUpdate(scrollFrame)`
...
- `SetLeftFrame(frame)`
- `SetCenterFrame(frame, skipSetPoint)`
...
- `CloseMenus()`
- `IsOptionFrameOpen()`
- `SecondsToTime(seconds, noSeconds)`
- `SecondsToTimeAbbrev(seconds)`
- `BuildListString(...)`
- `BuildColoredListString(...)`
- `BuildMultilineTooltip(globalStringName, tooltip, r, g, b)`
...
- `UIFrameIsFading(frame)`
- `UIFrameFlash(frame, fadeInTime, fadeOutTime, flashDuration, showWhenDone, flashInHoldTime, flashOutHoldTime)`
- `UIFrameFlashUpdate(elapsed)`
- `UIFrameFlashSwitch(frameName, mode)`
- `UIFrameIsFlashing(frame)`
- `UIFrameFlashStop(frame)`
- `SetButtonPulse(button, duration, pulseRate)`
- `ButtonPulse_OnUpdate(elapsed)`
- `ButtonPulse_StopPulse(button)`
- `tDeleteItem(table, item)`
- `MouseIsOver(frame, topOffset, bottomOffset, leftOffset, rightOffset)`
- `Model_OnLoad()`
- `Model_RotateLeft(model, rotationIncrement)`
- `Model_RotateRight(model, rotationIncrement)`
- `Model_OnUpdate(elapsedTime, model, rotationsPerSecond)`
- `ToggleGameMenu(clicked)`
- `SetDesaturation(texture, desaturation)`
- `ValidateFramePosition(frame, offscreenPadding, returnOffscreen)`
- `UIParent_ManageFramePositions()`
- `PlayerStatus_OnUpdate(elapsed)`
- `GetScreenHeightScale()`
- `GetScreenWidthScale()`
- `CursorUpdate()`
- `CursorOnUpdate()`
- `GetBindingText(name, prefix, returnAbbr)`
- `GetMaterialTextColors(material)`
...
**Functions:**
- `UnitFrame_Initialize(unit, name, portrait, healthbar, healthtext, manabar, manatext)`
- `UnitFrame_Update()`
- `UnitFrame_OnEvent(event)`
- `UnitFrame_OnEnter()`
- `UnitFrame_OnLeave()`
- `UnitFrame_OnUpdate(elapsed)`
- `UnitFrame_UpdateManaType(unitFrame)`
- `UnitFrameHealthBar_Initialize(unit, statusbar, statustext)`
- `UnitFrameHealthBar_Update(statusbar, unit)`
- `UnitFrameHealthBar_OnValueChanged(value)`
- `UnitFrameManaBar_Initialize(unit, statusbar, statustext)`
- `UnitFrameManaBar_Update(statusbar, unit)`
...
**Functions:**
- `ToggleFramerate()`
- `WorldFrame_OnUpdate(elapsed)`
- `TakeScreenshot()`
- `ScreenshotStatus_OnLoad()`
- `ScreenshotStatus_OnEvent(event)`
- `ScreenshotStatus_OnUpdate(elapsed)`
...
- `WorldMap_GetPOITextureCoords(index)`
...
- `WorldMapButton_OnClick(mouseButton, button)`
- `WorldMapButton_OnUpdate(elapsed)`
- `WorldMapUnit_OnEnter()`
- `WorldMapFrame_PingPlayerPosition()`
- `ToggleWorldMap()`

### WorldStateFrame.d.lua
...
- `CaptureBar_Create(id)`
- `CaptureBar_Update(id, value)`
- `WorldStateScoreFrame_OnLoad()`
- `WorldStateScoreFrame_Update()`
- `WorldStateScoreFrame_Resize(width)`
...
- `AutoFollowStatus_OnUpdate(elapsed)`
...
## Vanilla Client Core API Index

The following is an auto-generated index of all Vanilla Core API functions pulled from `docs/References/type-definitions/Client/`.

### Function/Action.d.lua
...
- `PickupAction(slot)`
- `PlaceAction(slot)`
- `SetActionBarToggles(bottomLeft, bottomRight, sideRight, sideRight2, alwaysShow)`
- `UseAction(slot, checkCursor, onSelf)`

### Function/Activity.d.lua
...
### Function/Addon.d.lua

**Functions:**
- `DisableAddOn(indexOrAddonName)`
- `DisableAllAddOns()`
- `EnableAddOn(indexOrAddonName)`
- `EnableAllAddOns()`
- `GetAddOnDependencies(indexOrAddonName)`
- `GetAddOnInfo(indexOrAddonName)`
- `GetAddOnMetadata(addon, variable)`
- `GetNumAddOns()`
- `IsAddOnLoaded(indexOrAddonName)`
- `IsAddOnLoadOnDemand(indexOrAddonName)`
- `LoadAddOn(indexOrAddonName)`
- `ResetDisabledAddOns()`
...
- `GetNumLaguages()`
- `RandomRoll(low, high)`
- `SendAddonMessage(prefix, message, type)`
- `SendChatMessage(message, type, language)`
- `SendChatMessage(message, type, language, channel)`
- `SendChatMessage(message, type, language, player)`

### Function/Crafting.d.lua
...
### Function/Cursor.d.lua

**Functions:**
- `CursorHasItem()`

### Function/Debugging.d.lua
...
### Function/FrameManagement.d.lua
...
### Function/Friend.d.lua

**Functions:**
- `AddFriend(name)`
- `GetFriendInfo(index)`
- `GetNumFriends()`
- `RemoveFriend(nameOrIndex)`

### Function/Group.d.lua

**Functions:**
- `AcceptGroup()`
- `CheckReadyCheckTime(isReady)`
...
- `SetLootMethod(lootMethod, threshold)`
...
### Function/Inventory.d.lua

**Functions:**
- `AutoEquipCursorItem()`
- `BankButtonIDToInvSlotID(bankItemId, isBag)`
- `BankButtonIDToInvSlotID(bagId, isBag)`
- `CancelPendingEquip(index)`
- `ConfirmBindOnUse()`
- `ContainerIDToInventoryID(bagId)`
- `CursorCanGoInSlot(invSlot)`
- `EquipCursorItem(invSlot)`
- `GetInventoryAlertStatus(i)`
- `GetInventoryItemBroken(unit, invSlot)`
- `GetInventoryItemCooldown(unit, invSlot)`
- `GetInventoryItemCount(unit, invSlot)`
- `GetInventoryItemLink(unit, invSlot)`
- `GetInventoryItemQuality(unit, invSlot)`
- `GetInventoryItemTexture(unit, invSlot)`
- `GetInventorySlotInfo(slotName)`
- `GetMoney()`
- `GetWeaponEnchantInfo()`
- `HasWandEquipped()`
- `IsInventoryItemLocked(invSlot)`
- `KeyRingButtonIDToInvSlotID(keyRingButtonId)`
...
- `GetMerchantItemLink(itemIndex)`

### Function/KeyBinding.d.lua
...
### Function/Macro.d.lua

**Functions:**
- `CreateMacro(name, icon, body, one, isPerCharacter)`
- `DeleteMacro(indexOrName)`
- `EditMacro(index, name, icon, body, one, isPerCharacter)`
...
- `GetMapContinents()`
- `GetMapInfo()`
- `GetMapLandmarkInfo(landmarkIndex)`
- `GetMapOverlayInfo(overlayIndex)`
...
- `CreateWorldMapArrowFrame(frame)`
- `UpdateWorldMapArrowFrames()`
- `ShowWorldMapArrowFrame(bool)`
- `PositionWorldMapArrowFrame(x, y)`

### Function/Movement.d.lua
...
- `HideNameplates()`
- `RegisterCVar(varname, initialValue)`
- `ResetPerformanceValues()`
- `ResetTutorials()`
- `SetBaseMip(value)`
- `SetCVar(varname, value, scriptCVar)`
- `SetDoodadAnim()`
- `SetEuropeanNumbers(flag)`
- `SetFarclip(value)`
- `SetGamma(value)`
- `SetLayoutMode()`
...
### Function/Skill.d.lua

**Functions:**
- `GetNumSkillLines()`
- `GetSkillLineInfo(skillIndex)`

### Function/Spell.d.lua
...
- `ToggleSpellAutocast(spellIndex, bookIndex)`
- `UpdateSpells()`

### Function/System.d.lua
...
- `debuginfo()`
- `getglobal(objectName)`
- `setglobal(objectName, value)`

### Function/Targetting.d.lua
...
- `TargetLastEnemy()`
- `TargetLastTarget()`
- `TargetNearestEnemy(reverseFlag)`
- `TargetNearestFriend()`
- `TargetNearestPartyMember()`
- `TargetNearestRaidMember()`
- `TargetUnit(unit)`

### Function/TradeSkill.d.lua
...
- `GetTradeSkillSubClassFilter(subclassIndex)`
- `SetTradeSkillInvSlotFilter(slotIndex, enable, exclusive)`
- `SetTradeSkillSubClassFilter(subclassIndex, enable, exclusive)`

### Function/Trainer.d.lua

**Functions:**
- `ExpandTrainerSkillLine(index)`
- `GetNumTrainerServices()`
- `IsTradeskillTrainer()`
- `SetTrainerServiceTypeFilter(type, enabled)`
...
- `LootButton:SetScript(scriptType, handler)`
...
- `Button:SetButtonState(state, isLock)`
...
### Widget/DressUpModel.d.lua

**Constants:**
- `DressUpModel = {}`

### Widget/EditBox.d.lua
...
- `EditBox:IsNumeric()`
- `EditBox:IsPassword()`
- `EditBox:SetAltArrowKeyMode(isEnabled)`
...
- `EditBox:ToggleInputLanguage(encoding)`
...
- `FontString:SetNonSpaceWrap(isWrap)`
...
- `Frame:SetClampedToScreen(isClamped)`
...
### Widget/GameTooltip.d.lua

**Constants:**
- `GameTooltip = {}`

**Functions:**
- `GameTooltip:AddDoubleLine(textL, textR, lr, lg, lb, rr, rg, rb)`
- `GameTooltip:AddFontStrings(leftstring, rightstring)`
- `GameTooltip:AddLine(text, r, g, b, isWrap)`
...
- `GameTooltip:SetInventoryItem(unit, slot, isTerse)`
...
- `GameTooltip:SetOwner(frame, anchor, x, y)`
- `GameTooltip:SetPadding(right)`
...
- `GameTooltip:SetSpell(spellIndex, spellbookTabNum)`
- `GameTooltip:SetTalent(tabIndex, talentIndex)`
- `GameTooltip:SetText(text, r, g, b, a, textWrap)`
...
- `GameTooltip:SetUnitBuff(unit, auraIndex, auraFilter)`
- `GameTooltip:SetUnitDebuff(unit, auraIndex, auraFilter)`

### Widget/LayeredRegion.d.lua
...
- `LayeredRegion:SetVertexColor(r, g, b, a)`

### Widget/LootButton.d.lua

**Constants:**
- `LootButton = {}`

### Widget/MessageFrame.d.lua

**Constants:**
- `MessageFrame = {}`

### Widget/Minimap.d.lua
...
- `Region:IsShown()`
- `Region:IsVisible()`
- `Region:SetAllPoints(region)`
- `Region:SetHeight(height)`
- `Region:SetParent(parent)`
- `Region:SetPoint(point, relativeRegion, relativePoint, xOffset, yOffset)`
- `Region:SetPoint(point, xOffset, yOffset)`
- `Region:SetWidth(width)`
- `Region:Show()`

### Widget/ScrollFrame.d.lua

**Constants:**
- `ScrollFrame = {}`

### Widget/ScrollingMessageFrame.d.lua
...
### Widget/StatusBar.d.lua

**Constants:**
- `StatusBar = {}`

### Widget/TabardModel.d.lua

**Constants:**
- `TabardModel = {}`

### Widget/Texture.d.lua
...
- `Texture:SetDesaturated(isGreyscale)`
